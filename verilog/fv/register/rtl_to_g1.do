...
usage -auto -elapse
set log file fv/register/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root register -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/register/g1.v.gz
} else {
...
elaborate design -revised -root register
